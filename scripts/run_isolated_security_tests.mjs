...
const suites = ['test_stripe_checkout.ts', 'test_stripe_persistence.ts', 'test_consent_preferences.ts', 'test_device_permissions.ts', 'test_ad_consent.ts', 'test_auth_security.ts', 'test_billing_security.ts'];
let failed = false;
